  ...
  return (
    ...
    >
      <div className="relative aspect-video">
        ...
        <div className="absolute bottom-2 left-5 right-6">
          <h2 className="lg:text-4xl md:text-3xl text-2xl font-bold text-white text-shadow-sm truncate pb-0.5">
            {item.title}
          </h2>
        </div>
      </div>

      <div className="px-6 pt-1 pb-5 space-y-5">
        <p className="text-muted-foreground line-clamp-3 md:text-lg text-md">
